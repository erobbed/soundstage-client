...
Open [https://soundstage-api.herokuapp.com](https://soundstage-api.herokuapp.com) to view it in the browser.
...
```json
{
  ...
  "configurations": [{
    ...
    "type": "chrome",
    "request": "launch",
    "url": "https://soundstage-api.herokuapp.com",
...
In the WebStorm menu `Run` select `Edit Configurations...`. Then click `+` and select `JavaScript Debug`. Paste `https://soundstage-api.herokuapp.com` into the URL field and save the configuration.
